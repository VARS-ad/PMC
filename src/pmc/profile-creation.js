...
const PC_TEMPLATES = {
  residents: {
    ...
    headers: [
      ...
      'Date of birth','Passport number','Tenure','Lease start','Lease end','Monthly payment (AED)','Ownership start',
    ],
    examples: [
      ['Aisha Al Mansoori','aisha.almansoori@example.ae','+971 50 412 8839','Aljil Tower',12,'B-1204','Welcome2026!','1988-04-15','AB1234567','Owner','','','','2021-09-10'],
      ['Mohammed Al Hammadi','mohammed.alhammadi@example.ae','+971 55 234 1187','Aljil Tower',8,'A-803','Welcome2026!','1990-11-22','CD7654321','Tenant','2025-03-01','2026-02-28',12000,''],
    ],

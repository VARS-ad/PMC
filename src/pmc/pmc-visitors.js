      ...
      <div className="card">
        ...
        {visits === null ? (
          ...
          <table className="data-table">
            <thead><tr><th style={{width:'10%'}}>Date</th><th style={{width:'8%'}}>Time</th><th style={{width:'22%'}}>Visitor</th><th style={{width:'12%'}}>Type</th><th style={{width:'18%'}}>Building / Unit</th><th style={{width:'16%'}}>Permit</th><th style={{width:'14%'}}>Status</th></tr></thead>
            <tbody>

          ...
          <form onSubmit={handleStart}>
            ...
            <div style={{maxWidth:280,margin:'0 auto',display:'flex',flexDirection:'column',gap:14}}>
              ...
              <button type="submit" className="btn btn-primary" disabled={submitting}
                style={{width:'100%',padding:'14px 0',fontSize:13,background:'var(--bg-warm-dark)',border:'none',borderRadius:8,color:'#fff',fontWeight:700,letterSpacing:'0.08em',textTransform:'uppercase',display:'flex',justifyContent:'center',alignItems:'center',cursor: submitting ? 'default' : 'pointer',opacity: submitting ? 0.7 : 1,transition:'all .2s',boxSizing:'border-box'}}>

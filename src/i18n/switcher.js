  ...
  return (
    <div ref={ref} style={{position:'relative',display:'inline-block'}}>
      <button onClick={() => setOpen(!open)}
        ...
        <svg width={compact?9:11} height={compact?9:11} viewBox="0 0 24 24" fill="none" stroke="#a89a92" strokeWidth="2.5" style={{display:'block',flexShrink:0}}><polyline points="6 9 12 15 18 9"/></svg>
      </button>
      {open && (
